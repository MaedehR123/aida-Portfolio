        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px"}}>
           ...
           <Col md={4} className="project-card">
            <ProjectCard
              imgPath={login}
              isBlog={false}
              title="طراحی یک صفحه ورود مینیمال، سریع و کاربرپسند"
              description="یک صفحه ورود مدرن با تمرکز بر تجربه کاربری، طراحی مینیمال و قابلیت توسعه برای پروژه‌های واقعی."
